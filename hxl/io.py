...
import abc, collections, csv, io, io_wrapper, json, jsonpath_rw_ext, logging, re, requests, shutil, six, sys, tempfile, xlrd, xml.sax
...
class JSONInput(AbstractInput):
    ...
    def _select(self, selector, data):
        ...
        if selector is None:
            ...
            # full JSONpath
            path = jsonpath_rw_ext.parse(selector)
